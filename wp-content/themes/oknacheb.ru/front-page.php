  ...
  while(have_posts()) {
    ...
    <div class="okna-price">
      <div class="calculator">
        <h2 class="calculator__h">Выберите нужный размер:</h2>
    ...
    <div class="home-gallery">
      <div class="swiper-container s3 home-gallery__top">
        <div class="swiper-wrapper">
          <div class="swiper-slide home-gallery__top__slide">
            <div class="home-gallery__container">
              <div class="home-gallery__info">
                <i class="fas fa-info-circle"></i>
                <span class="home-gallery__info__subtitle">ДО</span>
                <p class="home-gallery__info__title">ул. Пирогова, д. 15</p>
              </div>
              <img class="home-gallery__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/do/balkon-do-01.jpg" alt="">
              <img class="home-gallery__overlay" src="<?php echo bloginfo("template_url"); ?>/img/plashka-legos.png" alt="">
            </div>

            <div class="home-gallery__container">
              <div class="home-gallery__info">
                <i class="fas fa-info-circle"></i>
                <span class="home-gallery__info__subtitle">ПОСЛЕ</span>
                <p class="home-gallery__info__title">ул. Пирогова, д. 15</p>
              </div>
              <img class="home-gallery__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/posle/balkon-posle-01.jpg" alt="">
              <img class="home-gallery__overlay" src="<?php echo bloginfo("template_url"); ?>/img/plashka-legos.png" alt="">
            </div>
          </div>
          ...
          <div class="swiper-slide home-gallery__top__slide">
            <div class="home-gallery__container">
              ...
              <img class="home-gallery__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/do/balkon-do-02.jpg" alt="">
              <img class="home-gallery__overlay" src="<?php echo bloginfo("template_url"); ?>/img/plashka-legos.png" alt="">
            </div>
            ...
            <div class="home-gallery__container">
              ...
              <img class="home-gallery__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/posle/balkon-posle-02.jpg" alt="">
              <img class="home-gallery__overlay" src="<?php echo bloginfo("template_url"); ?>/img/plashka-legos.png" alt="">
            </div>
          </div>
          ...
          <div class="swiper-slide home-gallery__top__slide">
            <div class="home-gallery__container">
              ...
              <img class="home-gallery__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/do/okno-do-01.jpg" alt="">
              <img class="home-gallery__overlay" src="<?php echo bloginfo("template_url"); ?>/img/plashka-legos.png" alt="">
            </div>
            ...
            <div class="home-gallery__container">
              ...
              <img class="home-gallery__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/posle/okno-posle-01.jpg" alt="">
              <img class="home-gallery__overlay" src="<?php echo bloginfo("template_url"); ?>/img/plashka-legos.png" alt="">
            </div>
          </div>
        </div>
      ...
      <div class="swiper-container home-gallery__thumbs">
        <div class="swiper-wrapper">
          <div class="swiper-slide home-gallery__thumbs__slide">
            <img class="home-gallery__thumbs__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/do/balkon-do-01.jpg" alt="">
            <img class="home-gallery__thumbs__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/posle/balkon-posle-01.jpg" alt="">
          </div>

          <div class="swiper-slide home-gallery__thumbs__slide">
            <img class="home-gallery__thumbs__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/do/balkon-do-02.jpg" alt="">
            <img class="home-gallery__thumbs__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/posle/balkon-posle-02.jpg" alt="">
          </div>

          <div class="swiper-slide home-gallery__thumbs__slide">
            <img class="home-gallery__thumbs__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/do/okno-do-01.jpg" alt="">
            <img class="home-gallery__thumbs__img" src="<?php echo bloginfo("template_url"); ?>/img/home-gallery/posle/okno-posle-01.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
